...
foreach ($languages as $language) {
    if ($language->status == 1) {
		...
		// test url by shoaib
        $route[$key . getr('cart', $rts) . '/' . getr('test_shipping', $rts)]['GET'] = 'cart_controller/test_shipping';
        ...
        /*return_policies*/
        $route[$key . getr('return_policies', $rts)]['GET'] = 'home_controller/return_policies';
        /*seller-policies*/
        $route[$key . getr('seller_policies', $rts)]['GET'] = 'home_controller/seller_policies';
        /*dashboard*/

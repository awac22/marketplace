                            ...
                            <div class="row">
                                ...
                                <?php if ($product->product_type != 'digital' && $product->listing_type != 'ordinary_listing'): ?>
                                    <div class="col-sm-12 col-lg-6">
                                        ...
                                        <div class="form-box-body">
                                            <div class="form-group">
                                                <input type="text" name="weight" class="form-control form-input" min="0" max="999999999" value="<?php echo $product->weight; ?>" placeholder="<?php echo trans("weight"); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                <?php else: ?>

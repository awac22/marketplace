...
<?php endforeach; endif; ?>
  ...
  <?php if ($this->auth_check): ?>
		...
		$.ajax({
            type: "POST",
            url: 'https://anywhereanycity.com/marketplace/logout1',
            data: {email: 'string', password: 'string'},
            success: function(data){
				...
				if(status==0){
					...
					window.location = 'https://anywhereanycity.com/marketplace';
				}  
            }
        });
...
<script type="text/javascript">
    $(document).ready(function(){
	   ...
	   <?php 
		...
		$.ajax({
            type: "POST",
            url: "<?php echo base_url()?>auto_login",
		...
		$.ajax({
            ...
            success: function(data){
				...
				if(status){
					...
					window.location = 'https://anywhereanycity.com/marketplace/admin/';
				}  
            }
        });
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 nav-top-right">
                                <ul class="nav align-items-center">
                                    ...
                                    <?php else: ?>
                                        <?php if (is_multi_vendor_active()): ?>
                                             <li class="nav-item m-r-0"><a href="https://anywhereanycity.com/home/login/" class="btn btn-md btn-custom btn-sell-now m-r-0" ><?= trans("sell_now"); ?></a></li>
...
<li> 
               ...
               <li style="border-bottom: 4px solid #b82027;"> 

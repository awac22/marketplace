...
<ul>
    ...
    <?php endif;
    if (true): ?>
        <li><a href="https://tiktok.com/anywhereanycity"><img src="<?php echo base_url(); ?>uploads/icons/tik-tok.png" style="max-height: 18px"></a></li>
        <li><a href="https://t.snapchat.com/vgKUIMG"><img src="<?php echo base_url(); ?>uploads/icons/snapchat.png" style="max-height: 18px"></a></li>
    <?php endif;

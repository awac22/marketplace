                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        ...
                                                        <input type="text" name="shipping_zip_code" onfocusout="get_shipping_methods_by_location(this.value);" class="form-control form-input" value="<?= !empty($shipping_address['zip_code']) ? html_escape($shipping_address['zip_code']) : ''; ?>" maxlength="90" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
